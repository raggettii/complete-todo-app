...
const PopupModal=  ({showModal,setShowmodal}) =>{
    ...
    return <>
    {showModal && <div className="bg-black background-blur-sm fixed inset-0 bg-opacity-30"> 
            < div className="mt-10 flex flex-col gap-5 items-center  ">
                <div className="place-self-end fa-xl  mt-[140px] mr-[530px] cursor-pointer" onClick={()=>{setShowmodal(false)}}><FontAwesomeIcon icon={faXmark} /></div>
                <div className="fixed mt-40 bg-indigo-400 rounded-lg shadow-2xl flex flex-col px-20 py-10 justify-center items-center">
                <InputBox onChange={(e) => setTitle(e.target.value)} label={"Title"} placeholder={"Enter Title of Task"}/>
